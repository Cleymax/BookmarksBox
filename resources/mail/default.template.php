<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <title><?= $mail ?></title>
    <style type="text/css"><?= file_get_contents(ROOT_PATH.'/../resources/mail/css/default.css') ?></style>
</head>
<body>
                            ...
                            <table width="280" cellpadding="0" cellspacing="0" border="0" align="left" class="devicewidth">
                                ...
                                <tr>
                                    <td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo">
                                        <div class="imgpop">
                                            <a href="#"><img src="<?= $_ENV['BASE_URL'] ?>/img/logo.png" alt="Logo" width="70" height="70" border="0" style="display:block; border:none; outline:none; text-decoration:none;" st-image="edit" class="logo"></a>
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
